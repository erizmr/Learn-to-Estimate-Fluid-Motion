...
def flop_count_operators(
    ...
    Note:
        The function runs the input through the modeling to compute flops.
        The flops of a detection modeling is often input-dependent, for example,
        the flops of box & mask head depends on the number of proposals &
        the number of detected objects.
        Therefore, the flops counting using a single input may not accurately
        reflect the computation cost of a modeling.

    Args:
        model: a detectron2 modeling that takes `list[dict]` as input.
        inputs (list[dict]): inputs to modeling, in detectron2's standard format.
    """
...
def activation_count_operators(
    ...
    Note:
        The function runs the input through the modeling to compute activations.
        The activations of a detection modeling is often input-dependent, for example,
